...
// Ürünlerin sayfaya render eden fonsiyonu tanımlıyoruz.
export function renderProducts(products, addToCartCallback){
   ...
   // Ürünlerin HTML formatında listeye eklenmesi için products dizisini dönüp her bir product için ekranı product cartını aktardık.
